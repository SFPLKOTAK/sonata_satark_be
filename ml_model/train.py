...
from .config import MODEL_FILE_PATH, CLASSIFIER_FILE_PATH, LABEL_ENCODER_PATH, METRICS_FILE_PATH, FEATURE_COLS, score_to_grade
...
def train_model(data_source_df: pd.DataFrame = None, csv_filepath: str = None) -> dict:
    ...
    print("   [MODEL FIT] Regressor and Classifier trained successfully.")
    ...
    metrics = {
        ...
        'model_type': 'XGBRegressor + XGBClassifier' if HAS_XGBOOST else 'GradientBoosting',
