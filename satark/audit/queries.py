...
class GetBranchSameMobileDataQuery(Query):
    def __init__(self, branch_id: str = None, branch_name: str = None, as_on_date: str = None, report_type: str = 'Same-Mobile-Customer'):
        self.branch_id = branch_id or str(branch_name or '')
        self.as_on_date = as_on_date or '2026-06-08'
        self.report_type = report_type or 'Same-Mobile-Customer'


class GetBranchSameMobileDataQueryHandler(QueryHandler):
    def execute(self, query: GetBranchSameMobileDataQuery) -> dict:
        branch_id = query.branch_id
        as_on_date = query.as_on_date
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                rows = cursor.fetchall()
                print(f"[SAME MOBILE DATA] Branch: {branch_id}, Date: {as_on_date}, Total rows fetched: {len(rows)}")
            ...
            log_error(f"GetBranchSameMobileDataQueryHandler failed: {str(e)}")
            print(f"[SAME MOBILE DATA ERROR]: {str(e)}")
            raise e


class GetBranchSameAadhaarDataQuery(Query):
    def __init__(self, branch_id: str = None, branch_name: str = None, as_on_date: str = None, report_type: str = 'Same-Aadhar-Customer'):
        self.branch_id = branch_id or str(branch_name or '')
        self.as_on_date = as_on_date or '2026-06-08'
        self.report_type = report_type or 'Same-Aadhar-Customer'


class GetBranchSameAadhaarDataQueryHandler(QueryHandler):
    def execute(self, query: GetBranchSameAadhaarDataQuery) -> dict:
        branch_id = query.branch_id
        as_on_date = query.as_on_date
        report_type = query.report_type
        try:
            ...
            with connection.cursor() as cursor:
                ...
                rows = cursor.fetchall()
                print(f"[SAME AADHAAR DATA] Branch: {branch_id}, Date: {as_on_date}, Total rows fetched: {len(rows)}")
            ...
            log_error(f"GetBranchSameAadhaarDataQueryHandler failed: {str(e)}")
            print(f"[SAME AADHAAR DATA ERROR]: {str(e)}")
            raise e


class GetBranchSameAddressDataQuery(Query):
    def __init__(self, branch_id: str = None, branch_name: str = None, as_on_date: str = None, report_type: str = 'Same-Address-Customer'):
        self.branch_id = branch_id or str(branch_name or '')
        self.as_on_date = as_on_date or '2026-06-08'
        self.report_type = report_type or 'Same-Address-Customer'


class GetBranchSameAddressDataQueryHandler(QueryHandler):
    def execute(self, query: GetBranchSameAddressDataQuery) -> dict:
        branch_id = query.branch_id
        as_on_date = query.as_on_date
        report_type = query.report_type
        try:
            ...
            with connection.cursor() as cursor:
                ...
                rows = cursor.fetchall()
                print(f"[SAME ADDRESS DATA] Branch: {branch_id}, Date: {as_on_date}, Total rows fetched: {len(rows)}")
            ...
            log_error(f"GetBranchSameAddressDataQueryHandler failed: {str(e)}")
            print(f"[SAME ADDRESS DATA ERROR]: {str(e)}")
            raise e
